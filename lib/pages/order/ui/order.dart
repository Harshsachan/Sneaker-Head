...
class OneCreateOrder extends StatefulWidget {
  ...
  const OneCreateOrder({Key? key, required this.product,required this.placeOrderRepo}) : super(key: key);
  ...
  void _showCouponDialog(BuildContext context) {
    if (couponApplied) {
      ...
      setState(() {
        ...
        couponApplied = false;
        couponSavings=0;
        orderPrice =widget.product.price!.toDouble(); // Reset the orderPrice to original value
      });
